...
Test(mach, should_verify_that_a_function_is_called)
{
  expect_one_call("foo")
    .when([]() {
      actual_call("foo");
...
Test(mach, should_fail_when_a_function_is_not_called)
{
  cr_assert_throw(
    expect_one_call("foo")
      .when([]() {
...
Test(mach, should_fail_when_the_wrong_function_is_called)
{
  cr_assert_throw(
    expect_one_call("foo")
      .when([]() {
...
Test(mach, should_fail_when_a_function_is_called_unexpectedly)
{
  cr_assert_throw(
    actual_call("foo"),
    UnexpectedCallError);
